/*************************************************************************************
   ...
   Supported IC : Si2151
   Compiled for ROM 61 firmware 1_1_build_3
   Revision: 0.2
   Tag:  ROM61_1_1_build_3_V0.2
   Date: August 07 2014
  (C) Copyright 2014, Silicon Laboratories, Inc. All rights reserved.
**************************************************************************************/
#define   Si2151_COMMAND_PROTOTYPES
#define TUNER_POLLING_TIME_MIN  900 // us
#define TUNER_POLLING_TIME_MAX  1000 // us
...
unsigned char Si2151_pollForResetState (L1_Si2151_Context *api)
{
  ...
  while (cnt <1000){ /* wait a maximum of 1000ms */
    ...
    usleep_range(TUNER_POLLING_TIME_MIN,TUNER_POLLING_TIME_MAX);
    cnt++;
  }
    ...
    switch (cmd_code) {
     ...
     case         Si2151_PART_INFO_CMD_CODE:
      sprintf(msg,"PART_INFO ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-SERIAL   "); sprintf(msg,"%s%lu", msg, api->rsp->part_info.serial);
     ...
     case         Si2151_PART_INFO2_CMD_CODE:
      sprintf(msg,"PART_INFO2 ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-SERIAL   "); sprintf(msg,"%s%lu", msg, api->rsp->part_info2.serial);
     break;
    #endif /*     Si2151_PART_INFO2_CMD */
     ...
     case         Si2151_TUNER_STATUS_CMD_CODE:
      sprintf(msg,"TUNER_STATUS ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-FREQ     "); sprintf(msg,"%s%lu", msg, api->rsp->tuner_status.freq);
