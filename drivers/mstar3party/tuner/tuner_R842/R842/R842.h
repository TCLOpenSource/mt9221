...
#define R842_VERSION     "R842_v1.9H5"
...
extern UINT8 R842_TF_Low_Check(UINT8 TF_Low_Type);
extern UINT8 R842_TF_Mid_Check(UINT8 TF_Mid_Type);
extern UINT8 R842_TF_LPF_Check(void);
