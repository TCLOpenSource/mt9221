...
#define VERSION   "R850_GUI_v1.2K2_MSTAR_Format"
#define VER_NUM   0
#define CHIP_ID       0x98
//----------------------------------------------------------//
//                   Type Define                            //
...
//===========Share Xtal=========//
#define R850_SHARE_XTAL_MASTER    FALSE     //share Xtal, R850 is Master device, xtal_gm = normal (R32[4:3]=2'b11), xtal pw = highest
#define R850_SHARE_XTAL_SLAVE    FALSE     //share Xtal, R850 is Slave device, xtal_gm = off (R32[4:3]=2'b11), xtal pw = lowest, xtal cap = 0
...
extern UINT8*  pR850_IMR_done_flag ;
extern UINT8*  pR850_Initial_done_flag;
