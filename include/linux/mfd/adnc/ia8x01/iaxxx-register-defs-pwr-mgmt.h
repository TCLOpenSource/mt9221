...
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_MASK_VAL 0x0001ffff
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_RMASK_VAL 0x0001ffff
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_WMASK_VAL 0x0001fffe
 ...
 *
 << For IA8201 >>
 * 0 - System Clock
 * 1 - PORTA_CLK (io_ref0_clk2cnr_i)
 * 2 - PORTA_DO  (io_ref1_clk2cnr_i)
 * 3 - PORTB_CLK (io_ref2_clk2cnr_i)
 * 4 - PORTB_DO  (io_ref3_clk2cnr_i)
 * 5 - PORTC_CLK (io_ref4_clk2cnr_i)
 * 6 - PORTC_DO  (io_ref5_clk2cnr_i)
 * 7 - Reserved  (io_ref6_clk2cnr_i)
...
/*
 * << Valid only for IA8201 >>
 * Selects APLL Input frequency
 * 0  - 512    KHz
 * 1  - 768    KHz
 * 2  - 1.024  MHz
 * 3  - 1.536  MHz
 ...
 * otherwise - Invalid
 */
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_APLL_IN_FREQ_MASK 0x0001e000
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_APLL_IN_FREQ_RESET_VAL 0x0
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_APLL_IN_FREQ_POS 13
#define IAXXX_PWR_MGMT_SYS_CLK_CTRL_APLL_IN_FREQ_SIZE 4
...
/*** PWR_MGMT_A_CLK_CTRL (0x0e000038) ***/
/*
 * Controls the clocks that root from A_CLK
 */
#define IAXXX_PWR_MGMT_A_CLK_CTRL_ADDR (0x0e000038)
#define IAXXX_PWR_MGMT_A_CLK_CTRL_MASK_VAL 0x0000000f
#define IAXXX_PWR_MGMT_A_CLK_CTRL_RMASK_VAL 0x0000000f
#define IAXXX_PWR_MGMT_A_CLK_CTRL_WMASK_VAL 0x0000000f
#define IAXXX_PWR_MGMT_A_CLK_CTRL_RESET_VAL 0x00000000

/*
 * Selects the I2S Master frequency
 *   0 - 3.072 MHz
 *   1 - 6.144 MHz
 *   2 - 12.288 MHz
 *   3 - 24.576 MHz
 ...
 *   otherwise - Invalid
 */
#define IAXXX_PWR_MGMT_A_CLK_CTRL_I2S_MASTER_CLK_MASK 0x0000000f
#define IAXXX_PWR_MGMT_A_CLK_CTRL_I2S_MASTER_CLK_RESET_VAL 0x0
#define IAXXX_PWR_MGMT_A_CLK_CTRL_I2S_MASTER_CLK_POS 0
#define IAXXX_PWR_MGMT_A_CLK_CTRL_I2S_MASTER_CLK_SIZE 4

/*** PWR_MGMT_PWR_MGMT_STATS_CTRL (0x0e00003c) ***/
/*
 * power management statistics control
 */
#define IAXXX_PWR_MGMT_PWR_MGMT_STATS_CTRL_ADDR (0x0e00003c)
...
#define IAXXX_PWR_MGMT_REG_NUM 16
