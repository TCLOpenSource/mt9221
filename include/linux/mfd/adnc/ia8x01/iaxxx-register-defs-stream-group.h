...
#define IAXXX_STR_GRP_REGS_ADDR (0x02800000)

/*** STR_GRP_STR_CTRL (0x02800000) ***/
/*
 * Stream Control Register.
 */
#define IAXXX_STR_GRP_STR_CTRL_ADDR (0x02800000)
#define IAXXX_STR_GRP_STR_CTRL_MASK_VAL 0x0003ffff
#define IAXXX_STR_GRP_STR_CTRL_RMASK_VAL 0x0003ffff
#define IAXXX_STR_GRP_STR_CTRL_WMASK_VAL 0x0003ffff
 ...
 * 3 - Redbox 1-2
 * << For IA8201 & IA8206 >>
 * 4 - SRC enabled (Set SRC_MODE bit field)
 * 5-7 - Reserved
 * << For IA8508 >>
 * 4-7 - Reserved
 */
...
/*
 * << For IA8201 & IA8206 >>
 * Sets the mode for the synchronous Sample Rate Converter.
 * 0 - SRC downsample, divide by 2
 * 1 - SRC downsample, divide by 3
 * 2 - SRC downsample, divide by 4
 * 3 - SRC downsample, divide by 6
 * 4 - SRC upsample, multiply by 2
 * 5 - SRC upsample, multiply by 3
 * 6 - SRC upsample, multiply by 4
 * 7 - SRC upsample, multiply by 6
 * 8-15 - Reserved
 * << For IA8508 >>
 * 0-15 - Reserved
 */
#define IAXXX_STR_GRP_STR_CTRL_SRC_MODE_MASK 0x0003c000
#define IAXXX_STR_GRP_STR_CTRL_SRC_MODE_RESET_VAL 0x0
#define IAXXX_STR_GRP_STR_CTRL_SRC_MODE_POS 14
#define IAXXX_STR_GRP_STR_CTRL_SRC_MODE_SIZE 4

/*** STR_GRP_STR_STATUS (0x02800004) ***/
/*
 * Stream Status Register.
 */
#define IAXXX_STR_GRP_STR_STATUS_ADDR (0x02800004)
...
/*** STR_GRP_STR_FORMAT (0x02800008) ***/
/*
 * Stream Data Format Control.
 */
#define IAXXX_STR_GRP_STR_FORMAT_ADDR (0x02800008)
...
/*** STR_GRP_STR_PORT (0x0280000c) ***/
/*
 * Stream Port Register.
 */
#define IAXXX_STR_GRP_STR_PORT_ADDR (0x0280000c)
...
/*** STR_GRP_STR_CHN (0x02800010) ***/
/*
 * Stream Channel Register.
 */
#define IAXXX_STR_GRP_STR_CHN_ADDR (0x02800010)
...
/*** STR_GRP_STR_SYNC (0x02800014) ***/
/*
 * Stream Sync Register.
 */
#define IAXXX_STR_GRP_STR_SYNC_ADDR (0x02800014)
...
/*** STR_GRP_STR_AF_ERR_AFS_FIFO_OVERFLOW_CNT (0x02800018) ***/
/*
 * Audio Fabric Side Fifo Overflow error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_AFS_FIFO_OVERFLOW_CNT_ADDR (0x02800018)
...
/*** STR_GRP_STR_AF_ERR_AFS_FIFO_UNDERFLOW_CNT (0x0280001c) ***/
/*
 * Audio Fabric Side Fifo Underflow error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_AFS_FIFO_UNDERFLOW_CNT_ADDR (0x0280001c)
...
/*** STR_GRP_STR_AF_ERR_TUS_FIFO_OVERFLOW_CNT (0x02800020) ***/
/*
 * Audio Fabric Transfer Unit Side Fifo Overflow error counter
 */
#define IAXXX_STR_GRP_STR_AF_ERR_TUS_FIFO_OVERFLOW_CNT_ADDR (0x02800020)
...
/*** STR_GRP_STR_AF_ERR_TUS_FIFO_UNDERFLOW_CNT (0x02800024) ***/
/*
 * Audio Fabric Transfer Unit Side Fifo Underflow error counter
 */
#define IAXXX_STR_GRP_STR_AF_ERR_TUS_FIFO_UNDERFLOW_CNT_ADDR (0x02800024)
...
/*** STR_GRP_STR_AF_ERR_TUS_FIFO_COHERENCY_CNT (0x02800028) ***/
/*
 * Audio Fabric Transfer Unit Side Fifo Coherency error counter
 */
#define IAXXX_STR_GRP_STR_AF_ERR_TUS_FIFO_COHERENCY_CNT_ADDR (0x02800028)
...
/*** STR_GRP_STR_AF_ERR_DEADLINE_CNT (0x0280002c) ***/
/*
 * Audio Fabric Deadline scheduler error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_DEADLINE_CNT_ADDR (0x0280002c)
...
/*** STR_GRP_STR_AF_ERR_PHY_CNT (0x02800030) ***/
/*
 * Audio Fabric PHY error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_PHY_CNT_ADDR (0x02800030)
...
/*** STR_GRP_STR_AF_ERR_TIMEOUT_CNT (0x02800034) ***/
/*
 * Audio Fabric Timeout error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_TIMEOUT_CNT_ADDR (0x02800034)
...
/*** STR_GRP_STR_AF_ERR_ACCESS_CNT (0x02800038) ***/
/*
 * Audio Fabric Access error counter.
 */
#define IAXXX_STR_GRP_STR_AF_ERR_ACCESS_CNT_ADDR (0x02800038)
